namespace kotyk
{
    partial class ViewGroupsForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // panelForms
            // 
            panelForms.Controls.Add(GroupsGrid);
            ...
            // GroupsGrid
            // 
            GroupsGrid.AllowUserToAddRows = false;
            GroupsGrid.AllowUserToDeleteRows = false;
            GroupsGrid.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            GroupsGrid.Location = new Point(12, 42);
            GroupsGrid.Name = "GroupsGrid";
            GroupsGrid.ReadOnly = true;
            GroupsGrid.Size = new Size(764, 384);
            GroupsGrid.TabIndex = 0;
            // 
            // BackButton
            // 
